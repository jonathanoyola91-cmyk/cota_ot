...
urlpatterns = [
    ...
    path("familia/<int:member_id>/restablecer-contrasena/", views.member_password_reset, name="member_password_reset"),
    path("perfil/contrasena/", views.profile_password_change, name="profile_password_change"),
