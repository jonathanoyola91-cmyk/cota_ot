...
class PurchaseRequest(models.Model):
    ...
    bom = models.OneToOneField("bom.Bom", on_delete=models.PROTECT, related_name="compra")
    ...
    def __str__(self):
        return f"Solicitud Compra - BOM OT #{self.bom.workorder.numero}"
